...
using Debug = Element.Modules.Debug;
...
namespace Element
{
    internal static class Program
    {
        ...
        private static Element Main(string[] args)
        {
            try
            {
            ...
            Console.WriteLine("Element v" + VersionClass.currentVersion.name);
            ...
            Console.WriteLine(@"--- Element Terminal ---");
            Console.WriteLine(@"Welcome to the Element terminal");
            Console.WriteLine(@"");
        ...
        private static Element moduleTick(object sender, EventArgs e)
        {
